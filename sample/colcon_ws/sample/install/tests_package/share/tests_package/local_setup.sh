...
: ${AMENT_CURRENT_PREFIX:="/home/alex/git/rc-test-dev/sample/colcon_ws/sample/install/tests_package"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tests_package/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tests_package/environment/path.sh"
