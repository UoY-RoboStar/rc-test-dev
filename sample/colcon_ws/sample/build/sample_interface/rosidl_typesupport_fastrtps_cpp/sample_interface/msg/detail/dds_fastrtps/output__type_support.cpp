...
#include "sample_interface/msg/detail/output__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sample_interface::msg::Output & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sample_interface::msg::Output & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sample_interface::msg::Output;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sample_interface::msg::Output *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sample_interface::msg::Output *>(
    untyped_ros_message);
...
{
  return &sample_interface::msg::typesupport_fastrtps_cpp::_Output__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sample_interface, msg, Output)() {
  return &sample_interface::msg::typesupport_fastrtps_cpp::_Output__handle;
}
