...
#include "sample_interface/msg/detail/output__rosidl_typesupport_fastrtps_c.h"
...
using _Output__ros_msg_type = sample_interface__msg__Output;
...
size_t get_serialized_size_sample_interface__msg__Output(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Output__ros_msg_type * ros_message = static_cast<const _Output__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Output__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sample_interface__msg__Output(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sample_interface
size_t max_serialized_size_sample_interface__msg__Output(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sample_interface__msg__Output;
    is_plain =
      (
...
static size_t _Output__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sample_interface__msg__Output(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sample_interface, msg, Output)() {
