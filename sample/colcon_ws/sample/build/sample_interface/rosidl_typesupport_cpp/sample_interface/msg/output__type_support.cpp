...
static const _Output_type_support_symbol_names_t _Output_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sample_interface, msg, Output)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sample_interface, msg, Output)),
  }
};
...
{
  return &::sample_interface::msg::rosidl_typesupport_cpp::Output_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sample_interface, msg, Output)() {
  return get_message_type_support_handle<sample_interface::msg::Output>();
}
