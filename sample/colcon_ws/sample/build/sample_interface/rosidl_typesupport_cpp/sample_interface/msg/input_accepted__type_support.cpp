...
static const _InputAccepted_type_support_symbol_names_t _InputAccepted_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sample_interface, msg, InputAccepted)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sample_interface, msg, InputAccepted)),
  }
};
...
{
  return &::sample_interface::msg::rosidl_typesupport_cpp::InputAccepted_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sample_interface, msg, InputAccepted)() {
  return get_message_type_support_handle<sample_interface::msg::InputAccepted>();
}
