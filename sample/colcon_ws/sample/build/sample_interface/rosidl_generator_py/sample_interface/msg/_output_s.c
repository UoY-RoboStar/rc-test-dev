...
bool sample_interface__msg__output__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sample_interface.msg._output.Output", full_classname_dest, 35) == 0);
  }
  sample_interface__msg__Output * ros_message = _ros_message;
  {  // stamp
...
PyObject * sample_interface__msg__output__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sample_interface.msg._output");
